					...
					<nav id="tmMainNav" class="tm-main-nav">
						<ul>
							<li>
								...
								style="background-image: url('<?php echo base_url(); ?>img/constructive_bg_02.jpg');"
								data-bg-img="" data-page="#tm-section-1">
									<i class="fas fa-home tm-nav-fa-icon"></i>
									<span>Introduction</span>
								</a>
							</li>
							<li>
								<a href="#products" id="tmNavLink2" class="scrolly" data-bg-img="<?php echo base_url(); ?>img/constructive_bg_02.jpg" data-page="#tm-section-2" data-page-type="carousel">
									<i class="fas fa-map tm-nav-fa-icon"></i>
									<span>Our Products</span>
								</a>
							</li>							
							<li>
								<a href="#company" class="scrolly" data-bg-img="<?php echo base_url(); ?>img/constructive_bg_03.jpg" data-page="#tm-section-3">
									<i class="fas fa-users tm-nav-fa-icon"></i>
									<span>Our Company</span>
								</a>
							</li>
							<li>
								<a href="#contact" class="scrolly" data-bg-img="<?php echo base_url(); ?>img/constructive_bg_04.jpg" data-page="#tm-section-4">
						...
						<div>
							...
							<div class="tm-img-container">
								<div class="tm-img-slider">
									<a href="<?php echo base_url(); ?>img/gallery-img-01.jpg" class="tm-slider-img"><img src="<?php echo base_url(); ?>img/gallery-img-01-tn.jpg" alt="Image" class="img-fluid"></a>
									<a href="<?php echo base_url(); ?>img/gallery-img-02.jpg" class="tm-slider-img"><img src="<?php echo base_url(); ?>img/gallery-img-02-tn.jpg" alt="Image" class="img-fluid"></a>
									<a href="<?php echo base_url(); ?>img/gallery-img-03.jpg" class="tm-slider-img"><img src="<?php echo base_url(); ?>img/gallery-img-03-tn.jpg" alt="Image" class="img-fluid"></a>
									<a href="<?php echo base_url(); ?>img/gallery-img-04.jpg" class="tm-slider-img"><img src="<?php echo base_url(); ?>img/gallery-img-04-tn.jpg" alt="Image" class="img-fluid"></a>
									<a href="<?php echo base_url(); ?>img/gallery-img-05.jpg" class="tm-slider-img"><img src="<?php echo base_url(); ?>img/gallery-img-05-tn.jpg" alt="Image" class="img-fluid"></a>
									<a href="<?php echo base_url(); ?>img/gallery-img-06.jpg" class="tm-slider-img"><img src="<?php echo base_url(); ?>img/gallery-img-06-tn.jpg" alt="Image" class="img-fluid"></a>
								</div>
							</div>		            		          
						</div>       		          	
					</section>
